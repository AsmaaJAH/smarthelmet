...
class GasCoScreen extends StatefulWidget {
  GasCoScreen({super.key});

  @override
  State<GasCoScreen> createState() => _GasCoScreenState();
}

class _GasCoScreenState extends State<GasCoScreen>
  ...
  _TempretureScreenInit(double co) {
